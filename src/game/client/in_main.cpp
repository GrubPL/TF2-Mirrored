...
static ConCommand startmoveleft("+moveright", IN_MoveleftDown);
static ConCommand endmoveleft("-moveright", IN_MoveleftUp);
static ConCommand startmoveright("+moveleft", IN_MoverightDown);
static ConCommand endmoveright("-moveleft", IN_MoverightUp);
